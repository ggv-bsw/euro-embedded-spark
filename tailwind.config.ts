    ...
    extend: {
      ...
      keyframes: {
        ...
        "particle-2": {
          ...
          "33%": { transform: "translateY(-15px) translateX(-12px)", opacity: "0.5" },
          "66%": { transform: "translateY(-30px) translateX(8px)", opacity: "0.2" },
          "100%": { transform: "translateY(0) translateX(0)", opacity: "0.2" },
        },
        "particle-3": {
          "0%": { transform: "translateY(0) translateX(0) scale(1)", opacity: "0.25" },
          "50%": { transform: "translateY(-18px) translateX(-6px) scale(1.2)", opacity: "0.5" },
      ...
      animation: {
        ...
        "particle-2": "particle-2 8s ease-in-out infinite",
