...
const expertiseAreas = [
  {
    ...
    description: "We build low-level software for microcontrollers and electronic control units (ECUs).",
    expertise: [
  ...
  },
  {
    ...
    description: "From idea to industrialization — we design and prototype complete electronic products.",
    expertise: [
  ...
  },
  {
    ...
    description: "We create connected mobile apps and backend systems that bridge devices with users.",
    expertise: [
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-primary/10 via-background to-secondary/10">
        <div className="max-w-container mx-auto px-6 lg:px-20 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Deep technical knowledge across embedded systems, automotive, IoT, and full-stack development.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-container mx-auto px-6 lg:px-20">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className={index % 2 === 0 ? "order-1" : "order-1 md:order-2"}>
                ...
                <p className="text-xl text-muted-foreground mb-8">{area.description}</p>
                <Link to="/contact">
              ...
              <div className={index % 2 === 0 ? "order-2" : "order-2 md:order-1"}>
                <div className="bg-gradient-to-br from-card to-muted p-8 rounded-2xl border border-line">
                  <h3 className="text-xl font-semibold mb-6 text-primary">What We Deliver:</h3>
